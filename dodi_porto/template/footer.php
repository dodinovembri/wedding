		...
		<script src="../../assets/porto/vendor/jquery.validation/jquery.validate.min.js"></script>
		<script src="../../assets/porto/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
		...
		<script src="../../assets/porto/vendor/vide/jquery.vide.min.js"></script>
		<script src="../../assets/porto/vendor/vivus/vivus.min.js"></script>
		<script src="../../assets/porto/vendor/jquery.countdown/jquery.countdown.min.js"></script>
		...
		<!-- Current Page Vendor and Views -->
		<script src="../../assets/porto/js/views/view.contact.js"></script>
		
		<!-- Demo -->
		<script src="../../assets/porto/js/demos/demo-wedding.js"></script>
